...
class Config(object):
    ...
    def __init__(self):
        ...
        self.segment_features_directory = "/content/drive/MyDrive/PoliTo/Project/1s"

        self.ckpt_directory = "/content/drive/MyDrive/PoliTo/Project/error_recognition-main/checkpoints"
    ...
    def setup_parser(self):
        ...
        parser.add_argument("--ckpt_directory", type=str, default="/content/drive/MyDrive/PoliTo/Project/error_recognition-main/checkpoints", help="checkpoint directory")
